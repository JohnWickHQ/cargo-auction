...
- ТЗ довольно подробное, но есть много неописанной бизнес-логики, вопросы по которой всплывают уже в процессе
  тестирования. Например, специфика работы разных типов аукционов. Там по коммитам можно посмотреть, какую логику
  я разбирал и исправлял.
